...
* admin-in: add Protocol: tcp rules for destination port 22 and 8006 with the pve-public IPSet as destination. To support accessing remote clusters via jump hosts, you need to add a rule that allows vm data source 10.0.4.0/22 to reach destination 10.0.4.0/2 for port tcp 22.
