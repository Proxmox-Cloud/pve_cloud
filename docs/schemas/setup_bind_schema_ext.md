...
## <a name="lxcs"></a>42. Property `Bind Dns Inventory > lxcs`
...
### <a name="lxcs_items"></a>42.1. Bind Dns Inventory > lxcs > lxcs items
...
#### <a name="lxcs_items_vars"></a>42.1.1. Property `Bind Dns Inventory > lxcs > lxcs items > vars`
...
##### <a name="lxcs_items_vars_bind_master"></a>42.1.1.1. Property `Bind Dns Inventory > lxcs > lxcs items > vars > bind_master`
