...
## <a name="lxcs"></a>57. Property `Bind Dns Inventory > lxcs`
...
### <a name="lxcs_items"></a>57.1. Bind Dns Inventory > lxcs > lxcs items
...
#### <a name="lxcs_items_vars"></a>57.1.1. Property `Bind Dns Inventory > lxcs > lxcs items > vars`
...
##### <a name="lxcs_items_vars_bind_master"></a>57.1.1.1. Property `Bind Dns Inventory > lxcs > lxcs items > vars > bind_master`
