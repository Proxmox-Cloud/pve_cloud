...
#### <a name="qemus_items_hostname"></a>31.1.1. Property `VM Base Inventory > qemus > qemus items > hostname`
...
#### <a name="qemus_items_vars"></a>31.1.2. Property `VM Base Inventory > qemus > qemus items > vars`
...
#### <a name="qemus_items_target_host"></a>31.1.3. Property `VM Base Inventory > qemus > qemus items > target_host`
...
#### <a name="qemus_items_parameters"></a>31.1.4. Property `VM Base Inventory > qemus > qemus items > parameters`
...
#### <a name="qemus_items_network_config"></a>31.1.5. Property `VM Base Inventory > qemus > qemus items > network_config`
...
#### <a name="qemus_items_disk"></a>31.1.6. Property `VM Base Inventory > qemus > qemus items > disk`
...
##### <a name="qemus_items_disk_size"></a>31.1.6.1. Property `VM Base Inventory > qemus > qemus items > disk > size`
...
##### <a name="qemus_items_disk_options"></a>31.1.6.2. Property `VM Base Inventory > qemus > qemus items > disk > options`
...
##### <a name="qemus_items_disk_pool"></a>31.1.6.3. Property `VM Base Inventory > qemus > qemus items > disk > pool`
...
#### <a name="qemus_items_additional_disks"></a>31.1.7. Property `VM Base Inventory > qemus > qemus items > additional_disks`
...
##### <a name="qemus_items_additional_disks_items"></a>31.1.7.1. VM Base Inventory > qemus > qemus items > additional_disks > additional_disks items
...
###### <a name="qemus_items_additional_disks_items_size"></a>31.1.7.1.1. Property `VM Base Inventory > qemus > qemus items > additional_disks > additional_disks items > size`
...
###### <a name="qemus_items_additional_disks_items_options"></a>31.1.7.1.2. Property `VM Base Inventory > qemus > qemus items > additional_disks > additional_disks items > options`
...
###### <a name="qemus_items_additional_disks_items_pool"></a>31.1.7.1.3. Property `VM Base Inventory > qemus > qemus items > additional_disks > additional_disks items > pool`
