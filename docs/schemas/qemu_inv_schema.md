...
## <a name="target_pve_hosts"></a>7. Property `VM Inventory > target_pve_hosts`
...
### <a name="target_pve_hosts_items"></a>7.1. VM Inventory > target_pve_hosts > target_pve_hosts items
