...
## <a name="target_pve"></a>41. Property `VM Inventory > target_pve`
...
## <a name="stack_name"></a>42. Property `VM Inventory > stack_name`
...
## <a name="static_includes"></a>43. Property `VM Inventory > static_includes`
...
### <a name="static_includes_dhcp_stack"></a>43.1. Property `VM Inventory > static_includes > dhcp_stack`
...
### <a name="static_includes_proxy_stack"></a>43.2. Property `VM Inventory > static_includes > proxy_stack`
...
### <a name="static_includes_postgres_stack"></a>43.3. Property `VM Inventory > static_includes > postgres_stack`
...
### <a name="static_includes_bind_stack"></a>43.4. Property `VM Inventory > static_includes > bind_stack`
...
## <a name="include_stacks"></a>44. Property `VM Inventory > include_stacks`
...
### <a name="include_stacks_items"></a>44.1. VM Inventory > include_stacks > include_stacks items
...
#### <a name="include_stacks_items_stack_fqdn"></a>44.1.1. Property `VM Inventory > include_stacks > include_stacks items > stack_fqdn`
...
#### <a name="include_stacks_items_host_group"></a>44.1.2. Property `VM Inventory > include_stacks > include_stacks items > host_group`
...
#### <a name="include_stacks_items_qemu_ansible_user"></a>44.1.3. Property `VM Inventory > include_stacks > include_stacks items > qemu_ansible_user`
...
## <a name="root_ssh_pub_key"></a>45. Property `VM Inventory > root_ssh_pub_key`
...
## <a name="pve_ha_group"></a>46. Property `VM Inventory > pve_ha_group`
...
## <a name="target_pve_hosts"></a>47. Property `VM Inventory > target_pve_hosts`
...
### <a name="target_pve_hosts_items"></a>47.1. VM Inventory > target_pve_hosts > target_pve_hosts items
...
## <a name="qemus"></a>48. Property `VM Inventory > qemus`
...
### <a name="qemus_items"></a>48.1. VM Inventory > qemus > qemus items
...
#### <a name="qemus_items_hostname"></a>48.1.1. Property `VM Inventory > qemus > qemus items > hostname`
...
#### <a name="qemus_items_vars"></a>48.1.2. Property `VM Inventory > qemus > qemus items > vars`
...
#### <a name="qemus_items_target_host"></a>48.1.3. Property `VM Inventory > qemus > qemus items > target_host`
...
#### <a name="qemus_items_parameters"></a>48.1.4. Property `VM Inventory > qemus > qemus items > parameters`
...
#### <a name="qemus_items_network_config"></a>48.1.5. Property `VM Inventory > qemus > qemus items > network_config`
...
#### <a name="qemus_items_disk"></a>48.1.6. Property `VM Inventory > qemus > qemus items > disk`
...
##### <a name="qemus_items_disk_size"></a>48.1.6.1. Property `VM Inventory > qemus > qemus items > disk > size`
...
##### <a name="qemus_items_disk_options"></a>48.1.6.2. Property `VM Inventory > qemus > qemus items > disk > options`
...
##### <a name="qemus_items_disk_pool"></a>48.1.6.3. Property `VM Inventory > qemus > qemus items > disk > pool`
...
## <a name="tcp_proxies"></a>49. Property `VM Inventory > tcp_proxies`
...
### <a name="tcp_proxies_items"></a>49.1. VM Inventory > tcp_proxies > tcp_proxies items
...
#### <a name="tcp_proxies_items_proxy_name"></a>49.1.1. Property `VM Inventory > tcp_proxies > tcp_proxies items > proxy_name`
...
#### <a name="tcp_proxies_items_haproxy_port"></a>49.1.2. Property `VM Inventory > tcp_proxies > tcp_proxies items > haproxy_port`
...
#### <a name="tcp_proxies_items_node_port"></a>49.1.3. Property `VM Inventory > tcp_proxies > tcp_proxies items > node_port`
...
#### <a name="tcp_proxies_items_proxy_snippet"></a>49.1.4. Property `VM Inventory > tcp_proxies > tcp_proxies items > proxy_snippet`
...
#### <a name="tcp_proxies_items_external"></a>49.1.5. Property `VM Inventory > tcp_proxies > tcp_proxies items > external`
...
## <a name="qemu_default_user"></a>50. Property `VM Inventory > qemu_default_user`
...
## <a name="qemu_hashed_pw"></a>51. Property `VM Inventory > qemu_hashed_pw`
...
## <a name="qemu_base_parameters"></a>52. Property `VM Inventory > qemu_base_parameters`
...
## <a name="qemu_image_url"></a>53. Property `VM Inventory > qemu_image_url`
...
## <a name="qemu_keyboard_layout"></a>54. Property `VM Inventory > qemu_keyboard_layout`
...
## <a name="qemu_network_config"></a>55. Property `VM Inventory > qemu_network_config`
...
## <a name="qemu_global_vars"></a>56. Property `VM Inventory > qemu_global_vars`
...
## <a name="plugin"></a>57. Property `VM Inventory > plugin`
...
## <a name="ingress_domains"></a>58. Property `VM Inventory > ingress_domains`
...
### <a name="ingress_domains_items"></a>58.1. VM Inventory > ingress_domains > ingress_domains items
...
#### <a name="ingress_domains_items_zone"></a>58.1.1. Property `VM Inventory > ingress_domains > ingress_domains items > zone`
...
#### <a name="ingress_domains_items_names"></a>58.1.2. Property `VM Inventory > ingress_domains > ingress_domains items > names`
...
##### <a name="ingress_domains_items_names_items"></a>58.1.2.1. VM Inventory > ingress_domains > ingress_domains items > names > names items
...
#### <a name="ingress_domains_items_external"></a>58.1.3. Property `VM Inventory > ingress_domains > ingress_domains items > external`
