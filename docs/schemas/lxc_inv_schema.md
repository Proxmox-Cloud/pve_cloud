...
## <a name="lxcs"></a>7. Property `LXC Inventory > lxcs`
...
### <a name="lxcs_items"></a>7.1. LXC Inventory > lxcs > lxcs items
...
#### <a name="lxcs_items_hostname"></a>7.1.1. Property `LXC Inventory > lxcs > lxcs items > hostname`
...
#### <a name="lxcs_items_target_host"></a>7.1.2. Property `LXC Inventory > lxcs > lxcs items > target_host`
...
#### <a name="lxcs_items_vars"></a>7.1.3. Property `LXC Inventory > lxcs > lxcs items > vars`
...
#### <a name="lxcs_items_parameters"></a>7.1.4. Property `LXC Inventory > lxcs > lxcs items > parameters`
...
##### <a name="lxcs_items_parameters_rootfs"></a>7.1.4.1. Property `LXC Inventory > lxcs > lxcs items > parameters > rootfs`
...
##### <a name="lxcs_items_parameters_cores"></a>7.1.4.2. Property `LXC Inventory > lxcs > lxcs items > parameters > cores`
...
##### <a name="lxcs_items_parameters_memory"></a>7.1.4.3. Property `LXC Inventory > lxcs > lxcs items > parameters > memory`
...
##### <a name="lxcs_items_parameters_net0"></a>7.1.4.4. Property `LXC Inventory > lxcs > lxcs items > parameters > net0`
...
## <a name="lxc_global_vars"></a>8. Property `LXC Inventory > lxc_global_vars`
...
### <a name="lxc_global_vars_use_alternate_ssh_port"></a>8.1. Property `LXC Inventory > lxc_global_vars > use_alternate_ssh_port`
...
### <a name="lxc_global_vars_install_prom_systemd_exporter"></a>8.2. Property `LXC Inventory > lxc_global_vars > install_prom_systemd_exporter`
...
## <a name="lxc_base_parameters"></a>9. Property `LXC Inventory > lxc_base_parameters`
...
## <a name="lxc_os_template"></a>10. Property `LXC Inventory > lxc_os_template`
...
## <a name="plugin"></a>11. Property `LXC Inventory > plugin`
