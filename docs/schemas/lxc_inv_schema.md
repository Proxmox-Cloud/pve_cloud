...
## <a name="target_pve"></a>65. Property `LXC Inventory > target_pve`
...
## <a name="stack_name"></a>66. Property `LXC Inventory > stack_name`
...
## <a name="static_includes"></a>67. Property `LXC Inventory > static_includes`
...
## <a name="include_stacks"></a>68. Property `LXC Inventory > include_stacks`
...
### <a name="include_stacks_items"></a>68.1. LXC Inventory > include_stacks > include_stacks items
...
#### <a name="include_stacks_items_stack_fqdn"></a>68.1.1. Property `LXC Inventory > include_stacks > include_stacks items > stack_fqdn`
...
#### <a name="include_stacks_items_host_group"></a>68.1.2. Property `LXC Inventory > include_stacks > include_stacks items > host_group`
...
#### <a name="include_stacks_items_qemu_ansible_user"></a>68.1.3. Property `LXC Inventory > include_stacks > include_stacks items > qemu_ansible_user`
...
## <a name="root_ssh_pub_key"></a>69. Property `LXC Inventory > root_ssh_pub_key`
...
## <a name="pve_ha_group"></a>70. Property `LXC Inventory > pve_ha_group`
...
## <a name="target_pve_hosts"></a>71. Property `LXC Inventory > target_pve_hosts`
...
### <a name="target_pve_hosts_items"></a>71.1. LXC Inventory > target_pve_hosts > target_pve_hosts items
...
## <a name="lxcs"></a>72. Property `LXC Inventory > lxcs`
...
### <a name="lxcs_items"></a>72.1. LXC Inventory > lxcs > lxcs items
...
#### <a name="lxcs_items_hostname"></a>72.1.1. Property `LXC Inventory > lxcs > lxcs items > hostname`
...
#### <a name="lxcs_items_target_host"></a>72.1.2. Property `LXC Inventory > lxcs > lxcs items > target_host`
...
#### <a name="lxcs_items_vars"></a>72.1.3. Property `LXC Inventory > lxcs > lxcs items > vars`
...
#### <a name="lxcs_items_parameters"></a>72.1.4. Property `LXC Inventory > lxcs > lxcs items > parameters`
...
##### <a name="lxcs_items_parameters_rootfs"></a>72.1.4.1. Property `LXC Inventory > lxcs > lxcs items > parameters > rootfs`
...
##### <a name="lxcs_items_parameters_cores"></a>72.1.4.2. Property `LXC Inventory > lxcs > lxcs items > parameters > cores`
...
##### <a name="lxcs_items_parameters_memory"></a>72.1.4.3. Property `LXC Inventory > lxcs > lxcs items > parameters > memory`
...
##### <a name="lxcs_items_parameters_net0"></a>72.1.4.4. Property `LXC Inventory > lxcs > lxcs items > parameters > net0`
...
## <a name="lxc_global_vars"></a>73. Property `LXC Inventory > lxc_global_vars`
...
### <a name="lxc_global_vars_use_alternate_ssh_port"></a>73.1. Property `LXC Inventory > lxc_global_vars > use_alternate_ssh_port`
...
### <a name="lxc_global_vars_install_prom_systemd_exporter"></a>73.2. Property `LXC Inventory > lxc_global_vars > install_prom_systemd_exporter`
...
## <a name="lxc_base_parameters"></a>74. Property `LXC Inventory > lxc_base_parameters`
...
## <a name="lxc_os_template"></a>75. Property `LXC Inventory > lxc_os_template`
...
## <a name="plugin"></a>76. Property `LXC Inventory > plugin`
