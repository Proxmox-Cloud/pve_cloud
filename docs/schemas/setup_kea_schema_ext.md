...
## <a name="lxcs"></a>45. Property `General DHCP Inventory > lxcs`
...
### <a name="lxcs_items"></a>45.1. General DHCP Inventory > lxcs > lxcs items
...
#### <a name="lxcs_items_parameters"></a>45.1.1. Property `General DHCP Inventory > lxcs > lxcs items > parameters`
...
##### <a name="lxcs_items_parameters_net0"></a>45.1.1.1. Property `General DHCP Inventory > lxcs > lxcs items > parameters > net0`
...
#### <a name="lxcs_items_vars"></a>45.1.2. Property `General DHCP Inventory > lxcs > lxcs items > vars`
...
##### <a name="lxcs_items_vars_kea_dhcp_main"></a>45.1.2.1. Property `General DHCP Inventory > lxcs > lxcs items > vars > kea_dhcp_main`
