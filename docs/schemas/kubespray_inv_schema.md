...
## <a name="target_pve_hosts"></a>7. Property `K8s Kubespray Inventory > target_pve_hosts`
...
### <a name="target_pve_hosts_items"></a>7.1. K8s Kubespray Inventory > target_pve_hosts > target_pve_hosts items
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2025-12-16 at 01:59:15 +0000
