...
**Title:** Kubernetes kubespray inventory
...
## <a name="target_pve"></a>1. Property `Kubernetes kubespray inventory > target_pve`
...
## <a name="stack_name"></a>2. Property `Kubernetes kubespray inventory > stack_name`
...
## <a name="static_includes"></a>3. Property `Kubernetes kubespray inventory > static_includes`
...
### <a name="static_includes_dhcp_stack"></a>3.1. Property `Kubernetes kubespray inventory > static_includes > dhcp_stack`
...
### <a name="static_includes_proxy_stack"></a>3.2. Property `Kubernetes kubespray inventory > static_includes > proxy_stack`
...
### <a name="static_includes_postgres_stack"></a>3.3. Property `Kubernetes kubespray inventory > static_includes > postgres_stack`
...
### <a name="static_includes_bind_stack"></a>3.4. Property `Kubernetes kubespray inventory > static_includes > bind_stack`
...
### <a name="static_includes_cache_stack"></a>3.5. Property `Kubernetes kubespray inventory > static_includes > cache_stack`
...
## <a name="include_stacks"></a>4. Property `Kubernetes kubespray inventory > include_stacks`
...
### <a name="include_stacks_items"></a>4.1. Kubernetes kubespray inventory > include_stacks > include_stacks items
...
#### <a name="include_stacks_items_stack_fqdn"></a>4.1.1. Property `Kubernetes kubespray inventory > include_stacks > include_stacks items > stack_fqdn`
...
#### <a name="include_stacks_items_host_group"></a>4.1.2. Property `Kubernetes kubespray inventory > include_stacks > include_stacks items > host_group`
...
#### <a name="include_stacks_items_qemu_ansible_user"></a>4.1.3. Property `Kubernetes kubespray inventory > include_stacks > include_stacks items > qemu_ansible_user`
...
## <a name="root_ssh_pub_key"></a>5. Property `Kubernetes kubespray inventory > root_ssh_pub_key`
...
## <a name="pve_ha_group"></a>6. Property `Kubernetes kubespray inventory > pve_ha_group`
...
## <a name="pve_cloud_pytest"></a>7. Property `Kubernetes kubespray inventory > pve_cloud_pytest`
...
## <a name="qemus"></a>8. Property `Kubernetes kubespray inventory > qemus`
...
### <a name="qemus_items"></a>8.1. Kubernetes kubespray inventory > qemus > qemus items
...
#### <a name="qemus_items_hostname"></a>8.1.1. Property `Kubernetes kubespray inventory > qemus > qemus items > hostname`
...
#### <a name="qemus_items_vars"></a>8.1.2. Property `Kubernetes kubespray inventory > qemus > qemus items > vars`
...
#### <a name="qemus_items_target_host"></a>8.1.3. Property `Kubernetes kubespray inventory > qemus > qemus items > target_host`
...
#### <a name="qemus_items_parameters"></a>8.1.4. Property `Kubernetes kubespray inventory > qemus > qemus items > parameters`
...
#### <a name="qemus_items_network_config"></a>8.1.5. Property `Kubernetes kubespray inventory > qemus > qemus items > network_config`
...
#### <a name="qemus_items_disk"></a>8.1.6. Property `Kubernetes kubespray inventory > qemus > qemus items > disk`
...
##### <a name="qemus_items_disk_size"></a>8.1.6.1. Property `Kubernetes kubespray inventory > qemus > qemus items > disk > size`
...
##### <a name="qemus_items_disk_options"></a>8.1.6.2. Property `Kubernetes kubespray inventory > qemus > qemus items > disk > options`
...
##### <a name="qemus_items_disk_pool"></a>8.1.6.3. Property `Kubernetes kubespray inventory > qemus > qemus items > disk > pool`
...
#### <a name="qemus_items_k8s_roles"></a>8.1.7. Property `Kubernetes kubespray inventory > qemus > qemus items > k8s_roles`
...
##### <a name="qemus_items_k8s_roles_items"></a>8.1.7.1. Kubernetes kubespray inventory > qemus > qemus items > k8s_roles > k8s_roles items
...
## <a name="qemu_default_user"></a>9. Property `Kubernetes kubespray inventory > qemu_default_user`
...
## <a name="qemu_hashed_pw"></a>10. Property `Kubernetes kubespray inventory > qemu_hashed_pw`
...
## <a name="qemu_base_parameters"></a>11. Property `Kubernetes kubespray inventory > qemu_base_parameters`
...
## <a name="qemu_image_url"></a>12. Property `Kubernetes kubespray inventory > qemu_image_url`
...
## <a name="qemu_keyboard_layout"></a>13. Property `Kubernetes kubespray inventory > qemu_keyboard_layout`
...
## <a name="qemu_network_config"></a>14. Property `Kubernetes kubespray inventory > qemu_network_config`
...
## <a name="qemu_global_vars"></a>15. Property `Kubernetes kubespray inventory > qemu_global_vars`
...
## <a name="plugin"></a>16. Property `Kubernetes kubespray inventory > plugin`
...
## <a name="extra_control_plane_sans"></a>17. Property `Kubernetes kubespray inventory > extra_control_plane_sans`
...
### <a name="extra_control_plane_sans_items"></a>17.1. Kubernetes kubespray inventory > extra_control_plane_sans > extra_control_plane_sans items
...
## <a name="external_domains"></a>18. Property `Kubernetes kubespray inventory > external_domains`
...
### <a name="external_domains_items"></a>18.1. Kubernetes kubespray inventory > external_domains > external_domains items
...
#### <a name="external_domains_items_zone"></a>18.1.1. Property `Kubernetes kubespray inventory > external_domains > external_domains items > zone`
...
#### <a name="external_domains_items_expose_apex"></a>18.1.2. Property `Kubernetes kubespray inventory > external_domains > external_domains items > expose_apex`
...
#### <a name="external_domains_items_names"></a>18.1.3. Property `Kubernetes kubespray inventory > external_domains > external_domains items > names`
...
##### <a name="external_domains_items_names_items"></a>18.1.3.1. Kubernetes kubespray inventory > external_domains > external_domains items > names > names items
...
## <a name="cluster_cert_entries"></a>19. Property `Kubernetes kubespray inventory > cluster_cert_entries`
...
### <a name="cluster_cert_entries_items"></a>19.1. Kubernetes kubespray inventory > cluster_cert_entries > cluster_cert_entries items
...
#### <a name="cluster_cert_entries_items_zone"></a>19.1.1. Property `Kubernetes kubespray inventory > cluster_cert_entries > cluster_cert_entries items > zone`
...
#### <a name="cluster_cert_entries_items_names"></a>19.1.2. Property `Kubernetes kubespray inventory > cluster_cert_entries > cluster_cert_entries items > names`
...
##### <a name="cluster_cert_entries_items_names_items"></a>19.1.2.1. Kubernetes kubespray inventory > cluster_cert_entries > cluster_cert_entries items > names > names items
...
#### <a name="cluster_cert_entries_items_authoritative_zone"></a>19.1.3. Property `Kubernetes kubespray inventory > cluster_cert_entries > cluster_cert_entries items > authoritative_zone`
...
#### <a name="cluster_cert_entries_items_apex_zone_san"></a>19.1.4. Property `Kubernetes kubespray inventory > cluster_cert_entries > cluster_cert_entries items > apex_zone_san`
...
## <a name="tcp_proxies"></a>20. Property `Kubernetes kubespray inventory > tcp_proxies`
...
### <a name="tcp_proxies_items"></a>20.1. Kubernetes kubespray inventory > tcp_proxies > tcp_proxies items
...
#### <a name="tcp_proxies_items_proxy_name"></a>20.1.1. Property `Kubernetes kubespray inventory > tcp_proxies > tcp_proxies items > proxy_name`
...
#### <a name="tcp_proxies_items_haproxy_port"></a>20.1.2. Property `Kubernetes kubespray inventory > tcp_proxies > tcp_proxies items > haproxy_port`
...
#### <a name="tcp_proxies_items_node_port"></a>20.1.3. Property `Kubernetes kubespray inventory > tcp_proxies > tcp_proxies items > node_port`
...
#### <a name="tcp_proxies_items_proxy_snippet"></a>20.1.4. Property `Kubernetes kubespray inventory > tcp_proxies > tcp_proxies items > proxy_snippet`
...
#### <a name="tcp_proxies_items_external"></a>20.1.5. Property `Kubernetes kubespray inventory > tcp_proxies > tcp_proxies items > external`
...
## <a name="ceph_csi_sc_pools"></a>21. Property `Kubernetes kubespray inventory > ceph_csi_sc_pools`
...
### <a name="ceph_csi_sc_pools_items"></a>21.1. Kubernetes kubespray inventory > ceph_csi_sc_pools > ceph_csi_sc_pools items
...
#### <a name="ceph_csi_sc_pools_items_name"></a>21.1.1. Property `Kubernetes kubespray inventory > ceph_csi_sc_pools > ceph_csi_sc_pools items > name`
...
#### <a name="ceph_csi_sc_pools_items_default"></a>21.1.2. Property `Kubernetes kubespray inventory > ceph_csi_sc_pools > ceph_csi_sc_pools items > default`
...
#### <a name="ceph_csi_sc_pools_items_mount_options"></a>21.1.3. Property `Kubernetes kubespray inventory > ceph_csi_sc_pools > ceph_csi_sc_pools items > mount_options`
...
## <a name="acme_staging"></a>22. Property `Kubernetes kubespray inventory > acme_staging`
