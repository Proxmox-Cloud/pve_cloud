...
## <a name="target_pve"></a>33. Property `VM Base Schema > target_pve`
...
## <a name="stack_name"></a>34. Property `VM Base Schema > stack_name`
...
## <a name="static_includes"></a>35. Property `VM Base Schema > static_includes`
...
## <a name="include_stacks"></a>36. Property `VM Base Schema > include_stacks`
...
### <a name="include_stacks_items"></a>36.1. VM Base Schema > include_stacks > include_stacks items
...
#### <a name="include_stacks_items_stack_fqdn"></a>36.1.1. Property `VM Base Schema > include_stacks > include_stacks items > stack_fqdn`
...
#### <a name="include_stacks_items_host_group"></a>36.1.2. Property `VM Base Schema > include_stacks > include_stacks items > host_group`
...
#### <a name="include_stacks_items_qemu_ansible_user"></a>36.1.3. Property `VM Base Schema > include_stacks > include_stacks items > qemu_ansible_user`
...
## <a name="root_ssh_pub_key"></a>37. Property `VM Base Schema > root_ssh_pub_key`
...
## <a name="pve_ha_group"></a>38. Property `VM Base Schema > pve_ha_group`
...
## <a name="target_pve_hosts"></a>39. Property `VM Base Schema > target_pve_hosts`
...
### <a name="target_pve_hosts_items"></a>39.1. VM Base Schema > target_pve_hosts > target_pve_hosts items
