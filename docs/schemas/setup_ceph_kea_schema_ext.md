...
## <a name="lxcs"></a>48. Property `Ceph DHCP Inventory > lxcs`
...
### <a name="lxcs_items"></a>48.1. Ceph DHCP Inventory > lxcs > lxcs items
...
#### <a name="lxcs_items_parameters"></a>48.1.1. Property `Ceph DHCP Inventory > lxcs > lxcs items > parameters`
...
##### <a name="lxcs_items_parameters_net1"></a>48.1.1.1. Property `Ceph DHCP Inventory > lxcs > lxcs items > parameters > net1`
...
#### <a name="lxcs_items_vars"></a>48.1.2. Property `Ceph DHCP Inventory > lxcs > lxcs items > vars`
...
##### <a name="lxcs_items_vars_kea_dhcp_ceph_frontend_subnet"></a>48.1.2.1. Property `Ceph DHCP Inventory > lxcs > lxcs items > vars > kea_dhcp_ceph_frontend_subnet`
...
##### <a name="lxcs_items_vars_kea_dhcp_ceph_frontend_pool"></a>48.1.2.2. Property `Ceph DHCP Inventory > lxcs > lxcs items > vars > kea_dhcp_ceph_frontend_pool`
