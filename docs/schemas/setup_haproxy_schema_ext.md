...
## <a name="static_includes"></a>56. Property `HAProxy Inventory > static_includes`
...
### <a name="static_includes_postgres_stack"></a>56.1. Property `HAProxy Inventory > static_includes > postgres_stack`
...
## <a name="lxcs"></a>57. Property `HAProxy Inventory > lxcs`
...
### <a name="lxcs_items"></a>57.1. HAProxy Inventory > lxcs > lxcs items
...
#### <a name="lxcs_items_vars"></a>57.1.1. Property `HAProxy Inventory > lxcs > lxcs items > vars`
...
##### <a name="lxcs_items_vars_keepalived_master"></a>57.1.1.1. Property `HAProxy Inventory > lxcs > lxcs items > vars > keepalived_master`
