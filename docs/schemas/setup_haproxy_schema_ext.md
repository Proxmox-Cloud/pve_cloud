...
## <a name="static_includes"></a>89. Property `HAProxy Inventory > static_includes`
...
### <a name="static_includes_postgres_stack"></a>89.1. Property `HAProxy Inventory > static_includes > postgres_stack`
...
## <a name="lxcs"></a>90. Property `HAProxy Inventory > lxcs`
...
### <a name="lxcs_items"></a>90.1. HAProxy Inventory > lxcs > lxcs items
...
#### <a name="lxcs_items_vars"></a>90.1.1. Property `HAProxy Inventory > lxcs > lxcs items > vars`
...
##### <a name="lxcs_items_vars_keepalived_master"></a>90.1.1.1. Property `HAProxy Inventory > lxcs > lxcs items > vars > keepalived_master`
...
## <a name="lxc_global_vars"></a>91. Property `HAProxy Inventory > lxc_global_vars`
...
### <a name="lxc_global_vars_haproxy_defaults_section"></a>91.1. Property `HAProxy Inventory > lxc_global_vars > haproxy_defaults_section`
