...
class InventoryModule(BaseInventoryPlugin):
    ...
    async def stack_lxcs(self, inventory, online_pve_hosts, stack_vms, cluster_name):
        ...
        for vm in stack_vms:
            ...
            add_tasks.append(add_lxc_to_inv(inventory, online_pve_hosts, cluster_name, vm))
    ...
    def parse(self, inventory, loader, path, cache=True):
        ...
        asyncio.run(self.stack_lxcs(inventory, online_pve_hosts, stack_vms, yaml_data['target_pve']))
